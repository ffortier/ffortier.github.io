...
void isr80h_register_commands()
{
    ...
    isr80h_register_command(SYSTEM_COMMAND_INVOKE_SYSTEM_COMMAND, isr80h_command7_invoke_system_command);
    isr80h_register_command(SYSTEM_COMMAND_GET_PROGRAM_ARGUMENTS, isr80h_command8_get_program_arguments);
}